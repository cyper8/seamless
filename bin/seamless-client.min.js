...
/* harmony export (immutable) */ __webpack_exports__["Seamless"] = Seamless;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__storage__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ssync__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__socket__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__poller__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_complement_url_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__md5_js__ = __webpack_require__(2);
...
const md5 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__md5_js__["a" /* md5 */])();
function Seamless() {
    const storage = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__storage__["a" /* storage */])();
    ...
    function Connect(endpoint) {
        let url = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__utils_complement_url_js__["a" /* ComplementUrl */])(endpoint);
        let rh = md5(url);
        let connection;
        ...
        transmitter = (function (callback) {
            if ((!(url.search(/^wss?:\/\//i) < 0)) && WebSocket) {
                return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__socket__["a" /* socket */])(url, callback);
            }
            else {
                return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__poller__["a" /* poller */])(url.replace(/^ws/, "http"), callback);
            }
        })(Receive);
                ...
                elems.forEach(function (e, i, a) {
                    ...
                    if (e instanceof HTMLElement) {
                        ...
                        if (e.dataset.sync && (typeof window[e.dataset.sync] === "function")) {
                            ...
                            e.seamless = __WEBPACK_IMPORTED_MODULE_1__ssync__["a" /* SeamlessSync */].bind(e);
                        }
    ...
    return {
        ...
        disconnect: function (endpoint) {
            var url = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__utils_complement_url_js__["a" /* ComplementUrl */])(endpoint);
...
/* unused harmony default export */ var _unused_webpack_default_export = (element);
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = poller;
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = SeamlessSync;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__node_modules_basic_library_src_UI_Element_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_debounced_js__ = __webpack_require__(8);
...
function getElements(id, el) {
    ...
    for (var i = 0; i < el.length; i++) {
        ...
        if (e.length == 0) {
            (e = []).push(el[i].appendChild(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__node_modules_basic_library_src_UI_Element_js__["a" /* element */])("div#" + id)));
        }
                ...
                case "string":
                    getElements(key, [this]).forEach(function (e) {
                        if (e instanceof HTMLInputElement) {
                            e.value = data[key];
                            if (!e.onchange) {
                                e.onchange = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_debounced_js__["a" /* Debounced */])(function () {
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = ComplementUrl;
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = Debounced;
